...
class HapticPaletteViewController: UIViewController {
    ...
    private lazy var paletteSize: CGFloat = {
        ...
        let totalHeight = windowHeight - 160 - 4 * labelHeight - 2 * margin
    ...
    func layoutPaletteViews() {
        ...
        let yTop = windowHeight / 2 - 80 - margin - labelHeight - paletteSize
        let yBottom = windowHeight / 2 - 80 + labelHeight + margin
